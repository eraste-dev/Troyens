            ...
            <div class="row">
                <div class="col-10">
                    <div class="row">
                        ...
                        @foreach (Posts::getFlashInfos() as $item)
                            <div class="col-10">
                                {{ $item->contenu }}
                            </div>
                        @endforeach
            ...
            <div class="header-container d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li class="dropdown"><a href="#"><span>Notre Association</span> <i
                        ...
                        <li class="dropdown"><a href="#"><span>Nos Projets</span> <i
                                    class="bi bi-chevron-down"></i></a>
                            <ul>
                        ...
                        <li class="dropdown"><a href="#"><span>Nos Activités</span> <i
                            ...
                            <ul>
                                ...
                                <li class="dropdown"><a href="#"><span>Distinctions et Lauréats</span> <i
                                ...
                                <li class="dropdown"><a href="#"><span>Membres</span> <i
                                            class="bi bi-chevron-right"></i></a>
                                    <ul>
                        ...
                        <li class="dropdown"><a href="#"><span>Médiathèques</span> <i
                                    class="bi bi-chevron-down"></i></a>
                            <ul>
                        ...
                        <li><a class="nav-link scrollto" href="{{ route('contact') }}">Nous Contacter</a></li>
